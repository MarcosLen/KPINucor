...
div_style = {'padding': '3%', 'background-color': '#fff'}
graph_style = {'padding': '3%', 'padding-top': '1.5%', 'background-color': '#fff', 'height': '100%'}
big_div_style = {'padding': '0.75%', 'padding-top': '0.5%', 'padding-bottom': '0.5%'}
...
def pool_div(i):
    return html.Div([
        html.H4('{}'.format(pool_dict[i]['label']),
                style={'margin-left': '1%'}),
        html.Div([html.H6('Temperature: ', style={'margin-left': '2%'})]),
...
index_page = html.Div([
    ...
    dcc.Interval(id='interval_comp', interval=2000, n_intervals=0),
    html.Hr(),
    ...
    html.Div([
        ...
        html.Div([  # first row
            html.Div([
                html.Div([html.Div([
                    html.H4(id='title_label_1', style={'margin-left': '2%'}),
                    html.H1(id="value_label_1", style={'text-align': 'center', 'vertical-align': 'bottom'})
                    ], className='h-100', style=div_style)], className='col-4 pr-0'),
                html.Div([html.Div([
                    html.H4(id='title_label_2', style={'margin-left': '2%'}),
                    html.H1(id="value_label_2", style={'text-align': 'center'})
                ], className='h-100', style=div_style)], className='col-4 px-0'),
                html.Div([html.Div([
                    html.H4(id='title_label_3', style={'margin-left': '2%'}),
                    html.H1(id="value_label_3", style={'text-align': 'center'})
                ], className='h-100', style=div_style)], className='col-4 pl-0'),
            ], className='row'),
            ...
            html.Div([
                html.Div([  # filter div
                    html.Div([
                        ...
                        html.Div([
                            html.H5('Date range: ', style={'margin-top': 5, 'text-decoration': 'bold'}),
                            dcc.DatePickerRange(
                                id='date_picker',
                            ...
                            html.H5('Shift: ', style={'margin-top': '5%'}),
                            ...
                            html.Div([
                                html.H5('Recipe: ', style={'margin-top': '4%'}),
                                dbc.Select(id='filter_dropdown', options=recipes_options, value='All',
                                           style={'margin-left': '5%', 'width': '85%'}),
                            ]),
                            html.Div([
                                html.H5(id='extra_filter_p', style={'margin-top': '5%'}),
                ...
                html.Div([  # main graph div
                    html.Div([html.Div([
                        html.H4(id='main_graph_title'),
                        dcc.Graph(id='main_graph', style={'height': 365},
                                  config={'displayModeBar': False, 'showTips': False}, animate=True)
                        ], style=graph_style)], className='h-100', style={'padding-left': 0}),
        ...
        html.Div([  # third row for trolley tab
            html.Div([
                html.Div([html.Div([
                    html.H4(id='sm_graph_1_title', style={'margin-left': '2%', 'margin-top': '2%'}),
                    dcc.Graph(id='small_graph_1', style={'height': 300},
                              config={'displayModeBar': False, 'showTips': False})
                ], style=graph_style)], className='col-4 pr-0 h-100'),
                html.Div([html.Div([
                    html.H4(id='sm_graph_2_title', style={'margin-left': '2%', 'margin-top': '2%'}),
                    dcc.Graph(id='small_graph_2', style={'height': 300},
                              config={'displayModeBar': False, 'showTips': False})
                ], style=graph_style)], className='col-4 px-0 h-100'),
                html.Div([html.Div([
                    html.H4(id='sm_graph_3_title', style={'margin-left': '2%', 'margin-top': '2%'}),
                    dcc.Graph(id='small_graph_3', style={'height': 300},
                              config={'displayModeBar': False, 'showTips': False})
                ], style=graph_style)], className='col-4 pl-0 h-100'),
            ], className='row'),
        ...
        html.Div([  # pool row
            ...
            ], className='row', style={'padding-top': 0})
